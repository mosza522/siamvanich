    ...
    <div class="panel-body">
        ...
        <?php $__currentLoopData = $forums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="tr">
              ...
              <div class="td"><a href="<?php echo e(url('Category/normal/'.$forum->category_id)); ?>"><?php echo $forum->category_name; ?></a></div>
      ...
      <a href="<?php echo e(url('Category/normal/'.$data->id)); ?>" class="btn btn-inverse"><?php echo e($data->category_name); ?></a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </form>
      </div>
