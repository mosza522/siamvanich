        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 nopadding">
                    <div class="home">
                        <a href="index.php"><img class="logotop" src="<?php echo e(asset('assets/img/index/logo-01.png')); ?>"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-1"></div>
        <div class="col-md-10">
            <p class=" control-label text007" for="textinput">Username</p>
                <input id="textinput" name="textinput" type="text" placeholder="" class="form-control input-md"><span class="help-block"></span>
        </div>
    <div class="col-md-1"></div>
</div>
    ...
    <div class="col-md-1"></div>
        <div class="col-md-10 ">
            <p class=" control-label text007" for="textinput">Password</p>
                <input id="passwordinput" name="passwordinput" type="passwordinput" placeholder=""class="form-control input-md">
...
<div class="form-group">
    <div class="col-md-1"></div>
        ...
        <div class="col-md-12 col-sm-6 col-xs-12 info">
            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <a href="page02.php"><div class="text04">สมัครสมาชิกใหม่</div></a>
                <a href="page17.php"><div class="text04">รายชื่อห้ามโอนเงิน</div></a>
                <a href="page16.php"> <div class="text04">ติดต่อโฆษณา</div></a>
                <a href="page19.php">  <div class="text04">ลืมรหัสผ่าน</div></a>
        ...
        <div class=" text11 col-md-9 col-xs-12 center1 pading2">
            <img class="img-responsive ads" src="<?php echo e(asset('assets/img/index/banner1.png')); ?>">
            <img class="img-responsive ads" src="<?php echo e(asset('img/index/banner2.jpg')); ?>">
            <img class="img-responsive ads" src="<?php echo e(asset('img/index/banner3.jpg')); ?>">
            <img class="img-responsive ads" src="<?php echo e(asset('img/index/banner4.jpg')); ?>">
        </div>
    </div>
    ...
    <li data-target="#myCarousel" data-slide-to="4" class=""></li>
     ...
     <div class="carousel-inner">
      ...
      <img src="<?php echo e(asset('img/index/banner6.png')); ?>" alt="Premium Grade PET Cups">
    </div>
        <div class="item">
      <img src="<?php echo e(asset('img/index/banner6.png')); ?>" alt="Premium Grade PLA Cups">
    </div>
        <div class="item">
      <img src="<?php echo e(asset('img/index/banner6.png')); ?>" alt="Save Cost PP Cups">
    </div>
         <div class="item">
      <img src="<?php echo e(asset('img/index/banner6.png')); ?>" alt="Save Cost PP Cups">
    </div>
    ...
    <li data-target="#myCarousel" data-slide-to="4" class=""></li>
     ...
     <div class="carousel-inner">
     <div class="item active">
      <img src="<?php echo e(asset('img/index/banner7.png')); ?>" alt="Premium Grade PET Cups">
    </div>

    <div class="item">
      <img src="<?php echo e(asset('img/index/banner7.png')); ?>" alt="Premium Grade PLA Cups">
    </div>

    <div class="item">
      <img src="<?php echo e(asset('img/index/banner7.png')); ?>" alt="Save Cost PP Cups">
    </div>
...
การมิชอบต่อผู้อื่น </div>
        ...
        <br>
        <br>
            <img class="img-responsive margin02 headitem" src="<?php echo e(asset('img/index/new%20item1.png')); ?>">
        <div class="col-md-12 newitem centeritem">
             <div class="col-md-3 col-sm-6 newitem">
            <img class="img-responsive" src="<?php echo e(asset('img/index/img1.png')); ?>">
        ...
        <img class="img-responsive pading40 headitem" src="<?php echo e(asset('img/index/new%20item2.png')); ?>">
        <div class="col-md-12 newitem">
         ...
         <div class="col-md-2 col-sm-12">
            <div class="button-menu" style="padding-bottom:30px;">
                 <a href="page02.php" class="btn btn-block btn-primary btn-info text08">หมวดหมู่สินค้า</a>
...
-->
             <div class="">
                   <img class="img-responsive ads" src="<?php echo e(asset('img/index/a1.jpg')); ?>">
                   <img class="img-responsive ads" src="<?php echo e(asset('img/index/a2.jpg')); ?>">
                   <img class="img-responsive ads" src="<?php echo e(asset('img/index/a3.jpg')); ?>">
                   <img class="img-responsive ads" src="<?php echo e(asset('img/index/a4.jpg')); ?>">
                 </div>
