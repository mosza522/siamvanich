...
<?php $__env->startSection('content'); ?>
  ...
  <fieldset>
    <?php echo e(Form::open(array('url' => 'user' ,'id' => 'form1','files' => true))); ?>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <img class="img-responsive control-label marginimg02" src="<?php echo e(asset('assets/img/index/card1.png')); ?>">
  ...
  <div class="form-group">
    ...
    <div class="col-md-4 homeimg">
          <img class="img-responsive control-label marginimg" src="<?php echo e(asset('assets/img/index/card2.png')); ?>">
    </div>
...
<div class="col-md-9 g-recaptcha" data-sitekey="6Lc2DTEUAAAAABlyvzNlfitYy5AaRQQk8oVGAgYV" data-callback="onSubmit"></div>
  ...
  <div class="form-group page3botbut">
    ...
    <div class="control-label" for="singlebutton">
      <?php echo e(Form::submit('สมัครสมาชิก',array('class' => 'btn regisbot03 btn-inverse vovo1' ,
    ...
    <div class="col-md-5 col-xs-5">
      <?php echo e(Html::link('regis','ยกเลิก',array(
