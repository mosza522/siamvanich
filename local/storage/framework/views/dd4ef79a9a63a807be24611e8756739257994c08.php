...
<div class="logobg1"></div>
    ...
    <div class="col-md-7 padding25 padding25 padding20 bgw">
         ...
         <?php echo e(Html::image('assets/img/index/wellcom.png','',array('class'=>'img-responsive1 headp2 headp3 headp021'))); ?>
...
มาที่สำนักงานเพื่อจะทำการซื้อ-ขายสินค้า</div>
        ...
        <?php echo e(Html::image('assets/img/index/w1.png','',array('class' => 'img-responsive2 headp2'))); ?>
...
ลงในระบบบัญชีดำซึ่งจะเสียอนาคตและโอกาสในการทำธุรกิจต่างๆบนระบบอินเตอร์เน็ตในอนาคตเพราะท่านจะฉ้อโกงได้บางครั้งเท่านั้นแต่จะไม่ทุกครั้งไปและมีสิทธิติดคุกได้</div>
        ...
        <a href="regis_member"><img class="img-responsive3 butp2" src=<?php echo e(asset('assets/img/index/bumtom1.png')); ?>></a></div>

        <div class="col-md-6 col-sm-6">
        <a href="index"><img class="img-responsive3 butp3" src=<?php echo e(asset('assets/img/index/bumtom2.png')); ?>></a></div>
