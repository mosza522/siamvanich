            ...
            <li class='<?php echo e($renew); ?>'>
              ...
              <li class="treeview <?php echo e($contentIndex); ?><?php echo e($contentRules); ?><?php echo e($contentFirstPage); ?>">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="<?php echo e($contentRules); ?>"><a href="<?php echo e(url('backoffice/contentRules')); ?>"><i class="fa fa-circle-o" style="color : #605ca8" aria-hidden="true"></i> หน้ากฎ - กติกา</a></li>
                </ul>
                </li>
