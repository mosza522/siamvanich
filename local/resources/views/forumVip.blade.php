    ...
    <div class="panel-body">
        ...
        @foreach ($forums as $forum)
          ...
          <div class="tr">
              ...
              <div class="td"><a href="{{url('Category/vip/'.$forum->category_id)}}">{!!$forum->category_name!!}</a></div>
      ...
      @foreach ($cat as $data)
      <a href="{{url('Category/vip/'.$data->id)}}" class="btn btn-inverse">{{$data->category_name}}</a>
      @endforeach
      </div>
    </form>
      </div>
